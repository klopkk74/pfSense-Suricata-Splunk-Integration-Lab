...
- **Thu thập và phân tích log tập trung**: Sử dụng Splunk Enterprise để thu thập log từ pfSense, Suricata và mạng nội bộ, phân tích và tạo cảnh báo.
...
<p align="center">
  <img src="diagrams/architecture.png?v=2" alt="Architecture" width="80%">
  <br>
...
<p align="center">
  <img src="images/sql-injection/attack-success-result.png" alt="Attack Success Result" width="80%">
  <br>
  <em>Kết quả tấn công - Dữ liệu nhạy cảm bị rò rỉ</em>
</p>
